...
### 🏠 Dashboard Page
<p align="center">
  <img src="https://github.com/user-attachments/assets/36ce0edc-73fd-4922-9d59-ce285245049d" width="500"/>
</p>

**Description:**
- Displays a clean, modern book library interface  
- Shows all books in a responsive grid layout  
- Includes:
  - 🔍 Search by title or author  
  - 🎯 Genre filter dropdown  
  - 📚 Book cards with cover, title, author, rating  
- Smooth hover effects and intuitive navigation  
- Designed for quick exploration and discovery  

---
### 💬 Q&A Page

<p align="center">
  <img src="https://github.com/user-attachments/assets/f612b2d7-832b-4d32-a6fe-6e7e25352706" width="500"/>
</p>

**Description:**
- Interactive AI-powered question answering interface  
- Users can ask questions about books in natural language  
- Features:
  - 💬 Chat-style UI (user + AI messages)  
  - 🤖 AI-generated answers with context  
  - 🔗 Source references from indexed books  
